...
class InventoryController extends Controller
{
    ...
    public function stockStatus(Request $request): JsonResponse
    {
        ...
        try {
            $stocks = DB::transaction(function () use ($warehouseId) {
            ...
            return $this->errorResponse('Gagal memuat stock status. ' . $e->getMessage(), 500);
        }
    }
    ...
    public function stockCard(Request $request, $productId): JsonResponse
    {
        ...
        try {
            $responseData = DB::transaction(function () use ($productId, $warehouseId) {
            ...
            return $this->errorResponse('Gagal memuat stock card produk. ' . $e->getMessage(), 500);
        }
    }
    ...
    public function valuation(Request $request): JsonResponse
    {
        ...
        try {
            $report = DB::transaction(function () use ($warehouseId) {
                ...
                return [
                    ...
                    'summary' => [
                        ...
                        'valuation_difference' => round($grandTotalValuation - $ledgerBalance, 2),
                    ],
            ...
            return $this->errorResponse('Gagal memuat laporan valuasi inventory. ' . $e->getMessage(), 500);
        }
    }
}
